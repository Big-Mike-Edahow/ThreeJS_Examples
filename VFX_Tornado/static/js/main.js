...
import { luminance, cos, min, time, atan, uniform, pass, PI, TWO_PI, color } from 'three/tsl';
import { positionLocal, sin, texture, Fn, uv, vec2, vec3, vec4 } from 'three/tsl';
...
function main() {
    ...
    const perlinTexture = textureLoader.load('static/textures/rgb_256x256.png');
