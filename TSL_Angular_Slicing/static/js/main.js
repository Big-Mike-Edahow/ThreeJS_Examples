...
import { If, TWO_PI, atan, color, frontFacing } from 'three/tsl';
import { output, positionLocal, Fn, uniform, vec4 } from 'three/tsl';
...
function main() {
    ...
    hdrLoader.load('static/textures/royal_esplanade_2k.hdr.jpg', (environmentMap) => {
